            ...
            <div class="widget-box widget-color-blue" id="widget-box-2">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <!-- Form menu -->
                        <form class="form-horizontal" role="form" action="<?= base_url('menu/addmenu'); ?>" id="f_create">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="menu" name="menu" placeholder="" class="col-xs-10 col-sm-5" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="icon" name="icon" placeholder="" class="col-xs-10 col-sm-5" />
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
                    ...
                    <div class="widget-toolbox padding-8 clearfix text-center">
                        ...
                        <button class="btn btn-xs btn-primary " type="button" id="simpan">
